...
$my_query = new WP_Query("tag=featured,featured-de&showposts=$featurecount");
					...
					<div class="slide-container clearfix">
						...
						<?php } ?>
							...
							<div class="excerpt">
								...
								<?php } ?>
								<?php the_excerpt(); ?>
								<?php /* <p class="readmore"><a class="more-link" href="<?php the_permalink() ?>" rel="nofollow" title="<?php _e("Permanent Link to", "solostream"); ?> <?php the_title(); ?>"><?php _e("Read More", "solostream"); ?></a></p> */ ?>
							</div>
						</div>
