...
?>
			...
			<div class="cat-posts">
				<h2 class="feat-title"><span><a href="<?php echo esc_url(get_category_link(get_term_by('slug',get_option('solostream_cat_box_1'),'category')->term_id) ); ?>"><?php _e("news", "solostream"); ?></a></span></h2>
